...
const RespondentLineChart = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(
          `${import.meta.env.VITE_API_BASEURL}/cases/chartdata/respondent`,
         {
        headers: {
  ...
  const colors = ["#007bff", "#38a169", "#ffd700"]; 
...
export default RespondentLineChart
