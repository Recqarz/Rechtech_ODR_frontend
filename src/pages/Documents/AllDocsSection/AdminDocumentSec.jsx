            ...
            {allDocsForAdmin
              ...
              .map((ele) => {
                return (
                  <div
                    key={ele._id}
                    className="grid rounded-md grid-cols-[110px,1fr,60px] md:grid-cols-[120px,180px,1fr,60px]  lg:grid-cols-[100px,1fr,1fr,1fr,60px] text-sm text-white gap-4 px-2 py-2 shadow-lg bg-[#0f2d6b]"
                  >
                    ...
                    <p className="truncate hidden md:block">
                      {ele.attachments.length > 0 ? (
                        <IoMdDownload
                          ...
                          onClick={() => handleDownloadAll(ele.attachments)}
                        />
                      ) : (
                        "No attach"
                      )}
