...
const UpcomingMeetingCalendarDayArbitrator = () => {
  ...
  const getTodayMeetData = async () => {
    ...
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_API_BASEURL}/webex/recent-meetings/arbitrator`,
        {
...
export default UpcomingMeetingCalendarDayArbitrator;
